...
The resulting simulation plots are shown in Figures~\ref{fig:current_response} and~\ref{fig:voltage_response}.
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.85\linewidth]{voltage_response.jpg}
    \caption{Control voltage applied by the converter during the transient.}
    \label{fig:voltage_response}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.85\linewidth]{bode_speed_loop.jpg}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.85\linewidth]{speedloop_no_integral.jpg}
